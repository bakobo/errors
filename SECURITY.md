...
A small library of error-code machinery, imported by other Bakobo repos. In scope: anything that lets an error message or code carry data it should not, or that makes a caller misreport what went wrong.
